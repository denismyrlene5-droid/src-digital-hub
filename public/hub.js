(function () {
  ...
  function homePage() {
    ...
    <section class="hub-awards-feature"><div class="hub-container awards-feature-grid"><div><span class="hub-eyebrow">SRC AWARDS 2026</span><h2>THE COUNTDOWN HAS BEGUN.</h2><h3>Recognition. Excellence. Impact.</h3><p>Something big is coming to UCC Sandwich – WISE Campus.</p><a class="hub-btn hub-btn-gold" href="/awards">Explore Awards</a></div><div class="awards-countdown-card" aria-live="polite"><img class="awards-feature-logo" src="${data.organization.logoUrl}" alt="UCC crest"><strong id="homeAwardsCountdown">-- DAYS</strong><span id="homeAwardsCountdownLabel">Until SRC Awards 2026</span><small id="homeAwardsDate">15 September 2026 · Ghana</small></div></div></section>
